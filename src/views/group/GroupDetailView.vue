          ...
          <aside class="space-y-4">
            <section class="overflow-hidden rounded-xl border border-slate-200 bg-white">
              <div class="relative h-40 bg-slate-100">
                ...
                />
                <div
                  class="absolute inset-0 bg-gradient-to-b from-black/10 via-black/10 to-white/70"
                ></div>
              </div>
              ...
              <div class="p-4">
                <div class="flex items-start justify-between gap-3">
                  <div class="min-w-0">
                    <p class="text-[11px] font-semibold tracking-[0.14em] text-slate-400">
                      GROUP TRIP
                    </p>
              ...
              <div class="p-4">
                <div class="flex items-end justify-between">
                  ...
                  <p class="text-[12px] text-slate-500">{{ members.length }}명</p>
                </div>
                ...
                <ul class="mt-3 space-y-1">
                  ...
                  >
                    <div class="flex items-center gap-3 min-w-0">
                      <div
                        class="h-8 w-8 overflow-hidden rounded-full bg-white ring-1 ring-slate-200"
                      >
